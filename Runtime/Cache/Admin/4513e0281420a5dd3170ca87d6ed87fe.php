                    ...
                    <table class="layui-table" lay-data="{width:'100%',limit:<?php echo ($rows); ?>,id:'userData'}">
                        ...
                        <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                                ...
                                <td><div title="用户资金管理"
                                    ...
                                    下级商户数：<?php echo ((isset($vo["member_count"]) && ($vo["member_count"] !== ""))?($vo["member_count"]):0); ?>
...
<!-- 
                                        ...
                                        <a href="<?php echo U('User/agentCustomerList',array('parentid'=>$vo['id']));?>"><button class="layui-btn layui-btn-small" >查看下级商户</button></a>
