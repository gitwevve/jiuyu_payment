...
<div class="login-layout">
    ...
    <form method="post" class="layui-form" id="form_google" action="<?php echo U('Admin/Auth/google');?>">
        <input name="action_type" type="hidden" value="<?php echo ($action_type); ?>">
        <?php if(($google_token) == ""): ?><div class="lock-holder" style="text-align: center;width:300px;">
        ...
        <?php else: ?>
            <div class="lock-holder" style="text-align: center;width:300px;">
              <style type="text/css">
               ...
               <div class="code">
                <div class="arrow"></div>
                <div class="code-img">
                    <img  src="<?php echo U('Admin/Login/verifycode');?>" alt="点击更换" title="点击更换" onclick="changeCode()" class="captcha" name="codeimage" id="codeimage" border="0"/>
                </div>
            ...
            <label>图形验证码</label><input name="captcha_code" required lay-verify="required" type="text" class="input-code" id="captcha" placeholder="" pattern="[A-z0-9]{4}" title="验证码为4个字符" autocomplete="off" value="" >
              ...
              <input name="" class="input-button btn-submit" type="button" value="验证">
                ...
                <div class="submit2"></div>
            <div class="form-group">
            <p style="color:#fff;">找不到谷歌安全码？ <a href="<?php echo U('Auth/unbindGoogle');?>" style="color:#4395ff;text-decoration:none;">解绑</a></p>
            </div><?php endif; ?>
    </form>
    <div class="bottom">
    </div>
