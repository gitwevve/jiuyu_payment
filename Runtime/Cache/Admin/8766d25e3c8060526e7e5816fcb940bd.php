    ...
    <div class="col-md-12">
        <div class="ibox float-e-margins">
            ...
            <div class="ibox-title">
                <div class="layui-inline"><a href="javascript:;" onclick="javascript:history.back(-1);"><button class="layui-btn layui-btn-small">返回</button></a></div>
                <h5> <?php echo (shanghubianhao($parentUser["id"])); ?> - 下级商户</h5>
            ...
            <div class="ibox-content">
                ...
                <table class="layui-table" lay-data="{width:'100%',limit:<?php echo ($rows); ?>,id:'userData'}">
                    ...
                    <tr>
                        ...
                        <th lay-data="{field:'money', width:650,style:'background-color: #5FB878; color: #fff;cursor: pointer;'}">账户总额</th>
                    ...
                    <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                            ...
                            <td><div title="用户资金管理"
                                     onclick="member_money('商户：<?php echo ($vo["username"]); ?>','<?php echo U("User/usermoney",['userid'=>$vo["id"]]) ;?>',800,600)">可提现：<?php echo ($vo["balance"]); ?> 冻结：<?php echo ($vo["blockedbalance"]); ?>
                                今日(默认)交易量：<?php echo ((isset($vo["today_amount"]) && ($vo["today_amount"] !== ""))?($vo["today_amount"]):0); ?>
                                今日(默认)提现笔数：<?php echo ((isset($vo["today_withdraw_count"]) && ($vo["today_withdraw_count"] !== ""))?($vo["today_withdraw_count"]):0); ?>
                                今日(默认)待结算分润：<?php echo ((isset($vo["pre_settle"]) && ($vo["pre_settle"] !== ""))?($vo["pre_settle"]):0); ?>
            </div></td>
            ...
            <td>
                <div class="layui-btn-group">
                    ...
                    <!--<a href="<?php echo U('User/agentList',array('parentid'=>$vo['id']));?>" target="_blank"><button class="layui-btn layui-btn-small" >查看下级商户</button></a>-->
                    <a href="<?php echo U('Order/index',array('status' => '1or2', 'memberid'=>($vo['id'] + 10000)));?>" ><button class="layui-btn layui-btn-small" >交易查询</button></a>
                    <a href="<?php echo U('Withdrawal/index',array('memberid'=>($vo['id'] + 10000)));?>" ><button class="layui-btn layui-btn-small" >提现查询</button></a>
