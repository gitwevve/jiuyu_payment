                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <input type="text" name="p[agentname]" lay-verify="title" autocomplete="off"
                                   placeholder="上级代理名称" class="layui-input" value="<?php echo ($p["agentname"]); ?>">
                        </div>
                    </div>
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <input type="text" name="p[realname]" lay-verify="title" autocomplete="off"
                                   placeholder="姓名" class="layui-input" value="<?php echo ($p["realname"]); ?>">
                        </div>
                    </div>
                    <div class="layui-form-item">
                        <label class="layui-form-label">身份证号码：</label>
                        <div class="layui-input-block">
                            <input type="text" name="p[sfznumber]" lay-verify="identity" placeholder="身份证号码" autocomplete="off" class="layui-input" value="<?php echo ($p["sfznumber"]); ?>">
                        </div>
                    </div>
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <input type="text" name="p[address]" lay-verify="title" autocomplete="off"
                                   placeholder="联系地址" class="layui-input" value="<?php echo ($p["address"]); ?>">
                        </div>
                    </div>
