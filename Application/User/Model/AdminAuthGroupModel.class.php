...
{
    protected $tableName = 'member_auth_group';
    
    /**
     * 获取角色列表
     * @params $type=1有分页，2无分布全部数据
     */
    public function getGroupList($member_id, $user_id = 0)
    {
        $where = array(
        ...
        if(!$user_id){
            ...
            $field = "a.*,b.uid";
            $join = "LEFT JOIN member_auth_group_access b ON a.id=b.group_id AND b.uid={$user_id}";
