<?php
namespace Org\Util\Jp\util;

/**
 * 3DES加密解密算法，使用pkcs#5填充
 */
class DesHelper{
    public static $key = "cputest\0";
    ...
    public static function desEncode($in){
        $cryptBinary = openssl_encrypt($in, 'DES-ECB', self::$key, OPENSSL_RAW_DATA);
        return BaseSigner::asc2hex($cryptBinary);
    }
